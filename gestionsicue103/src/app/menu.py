...
root.geometry("400x300")  # Establecer tamaño inicial de la ventana
root.resizable(True, True)  # Hacer la ventana redimensionable

# Botones para abrir los programas
boton_crear_plan = tk.Button(root, text="Crear Plan de Convalidación", command=ejecutar_crear_plan, width=30, pady=10, font=("Arial", 12))
boton_crear_plan.pack(pady=10, expand=True)

boton_inscripcion = tk.Button(root, text="Registrar Inscripción", command=ejecutar_inscripcion, width=30, pady=10, font=("Arial", 12))
boton_inscripcion.pack(pady=10, expand=True)

boton_anular_inscripcion = tk.Button(root, text="Anular Inscripción", command=ejecutar_anular_inscripcion, width=30, pady=10, font=("Arial", 12))
boton_anular_inscripcion.pack(pady=10, expand=True)

# Configurar el pack para que sea redimensionable
